...
<body>
    ...
    <div class="wrap">
        <!--  -->
        <form action="<%=request.getContextPath()%>/portfolio/regist.do" role="form" method="post" name="registForm">
            <div>
                <label for="por_title">제목: </label><input type="text" id="por_title" name="por_title">
            </div>
            <br>
            <div>
                <label for="por_title">소제목: </label><input type="text" id="por_subtitle" name="por_subtitle">
            </div>
            <br>
            <div>
            ...
            <div>
                ...
                <textarea class="textarea" name="por_content" id="por_content" rows="20" placeholder="1000자 내외로 작성하세요." style="display: none;"></textarea>
            </div>
            <div>
